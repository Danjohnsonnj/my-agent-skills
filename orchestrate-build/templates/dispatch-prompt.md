<!-- The literal cold-start prompt the orchestrator launches a subagent with,
     after overwriting docs/_plan/_bus/handoff.md for this chunk. Pass it
...
1. Read `docs/_plan/HANDOFF.md` -> the "Required reading" listed
   in `docs/_plan/_bus/handoff.md`.
2. Do exactly the chunk described in `docs/_plan/_bus/handoff.md`. Stay in
...
6. Final action: overwrite `docs/_plan/_bus/handback.md` from
