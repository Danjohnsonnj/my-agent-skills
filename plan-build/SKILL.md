...
Start from docs/\_handoff/HANDOFF.md — the explicit entry point an agent is pointed at directly. Read it, then only the leaves under "Required reading (this phase)". Read process.md before committing.
